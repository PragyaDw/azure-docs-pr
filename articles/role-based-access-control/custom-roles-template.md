...
:::image type="content" source="~/reusable-content/ce-skilling/azure/media/template-deployments/new-pipeline.png" alt-text="Button to deploy the Resource Manager template to Azure." border="false":::
